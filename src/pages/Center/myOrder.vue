<template>
    <div class="order-right">
        <div class="order-content">
            ...
            <div class="orders">
                <table class="order-item" v-for="(record, index) in orderInfo.records" :key="record.id">
                    <thead>
                        <tr>
                            <th colspan="5">
                    ...
                    <tbody>
                        <tr v-for="(orderDetail, index) in record.orderDetailList" :key="orderDetail.skuId">
                            <td width="60%">
                                <div class="typographic">
                                    <img :src="orderDetail.imgUrl" style="width: 80px;height: 80px;">
            ...
            <div class="choose-order">
                <Pagination :pageNo='page' :pageSize="limit" :total='orderInfo.total' :continues="5"
                    @getPageNo="getPageNo" />
            </div>
